...
QT_MOC_LITERAL(1, 10, 17), // "sendSolvingString"
QT_MOC_LITERAL(2, 28, 0), // ""
QT_MOC_LITERAL(3, 29, 13) // "solvingString"

    },
    "Algorithm\0sendSolvingString\0\0solvingString"
};
...
void Algorithm::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sendSolvingString((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Algorithm::*)(const QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Algorithm::sendSolvingString)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Algorithm::sendSolvingString(const QString _t1)
{
