...
QT_MOC_LITERAL(4, 35, 8), // "hsvFrame"
QT_MOC_LITERAL(5, 44, 15), // "sendColorString"
QT_MOC_LITERAL(6, 60, 8), // "camIndex"
QT_MOC_LITERAL(7, 69, 11), // "colorString"
QT_MOC_LITERAL(8, 81, 16) // "clearColorString"

    },
    "ColorProcess\0sendHSVFrame\0\0cv::Mat\0"
    "hsvFrame\0sendColorString\0camIndex\0"
    "colorString\0clearColorString"
};
...
void ColorProcess::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->sendColorString((*reinterpret_cast< const int(*)>(_a[1])),(*reinterpret_cast< const QString(*)>(_a[2]))); break;
        case 2: _t->clearColorString(); break;
        default: ;
        }
        ...
        {
            using _t = void (ColorProcess::*)(const int & , const QString & );
        ...
        {
            using _t = void (ColorProcess::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ColorProcess::clearColorString)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 1
void ColorProcess::sendColorString(const int & _t1, const QString & _t2)
{
...
// SIGNAL 2
void ColorProcess::clearColorString()
{
